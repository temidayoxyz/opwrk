...
import { formatAgentDisplayName, formatEffortLabel, getCycledPrimaryAgentName, isPrimaryMode, type MobileControlsPanel } from './mobileControlsUtils';
...
export const ModelControls: React.FC<ModelControlsProps> = ({
    ...
    const getAgentDisplayName = () => {
        if (!uiAgentName) {
            ...
            return defaultAgent ? formatAgentDisplayName(defaultAgent.name, agentDisplayLabels) : agentDisplayLabels.selectAgent;
        }
        const agent = agents.find(a => a.name === uiAgentName);
        return formatAgentDisplayName(agent?.name ?? uiAgentName, agentDisplayLabels);
    };
