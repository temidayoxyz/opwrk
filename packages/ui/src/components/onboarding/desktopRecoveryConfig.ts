  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running OpWrk. Verify the address points to an OpWrk server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The OpWrk server at "${host || 'unknown'}" is not compatible with this app version. Update OpWrk on the server, then try again.`,
