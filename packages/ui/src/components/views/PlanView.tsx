    ...
    async (execution: TodoSendExecution) => {
      ...
      const planSubstance = resolvedPath
        ...
        : [
            instructionsText,
            '',
            'The plan is not stored as a file in the repository and has no file path. Its full current contents follow below this note and are the source of truth for the plan. Where the instructions above refer to the plan file, treat the plan as stored in OpWrk project knowledge (it is edited through the OpWrk UI): propose plan revisions as plan text in the chat rather than editing a file.',
            '',
            content,
          ].join('\n');
