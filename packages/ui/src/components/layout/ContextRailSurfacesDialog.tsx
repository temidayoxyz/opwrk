...
/**
 * Which surfaces the context rail shows. OpWrk starts with developer panels
 * hidden, and stores later choices as the hidden set. Newly added surfaces
 * therefore appear unless the user explicitly hides them. Hidden surfaces also
 * leave the digit shortcuts (the rail and shortcut share one visibility filter).
 */
