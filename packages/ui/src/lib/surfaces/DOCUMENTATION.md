...
- Fresh OpWrk installs put work surfaces first and hide Git, pull requests,
  changes, walkthroughs, and the terminal. Those developer surfaces remain in
  the configure dialog and command palette, and an explicit user choice always
