...
/** Developer-focused panels stay available, but do not lead the fresh OpWrk experience. */
export const DEFAULT_CONTEXT_RAIL_HIDDEN_SURFACES: readonly BuiltInContextSurfaceId[] = [
  'git',
  'pr',
  'diff',
  'walkthrough',
