...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o OpWrk para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "OpWrk instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao OpWrk",
  ...
  "mobile.connect.password.placeholder": "Senha do OpWrk",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do OpWrk.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor OpWrk.",
  ...
  "sessions.sidebar.header.actions.addProject": "Adicionar espaço de trabalho",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Sobre o OpWrk",
  ...
  "chat.chatInput.chooseProject": "Escolher espaço de trabalho",
  ...
  "sessions.sidebar.project.actions.projectMenu": "Menu do espaço de trabalho",
  "sessions.sidebar.project.actions.newSession": "Nova sessão",
  "sessions.sidebar.project.actions.closeProject": "Fechar espaço de trabalho",
  ...
  "contextRail.surface.editor.description": "Explorar e editar arquivos do espaço de trabalho",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor OpWrk ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextRail.surface.notes.description": "Notas, tarefas, planos e memória do agente do espaço de trabalho",
  ...
  "contextRail.surface.notes": "Conhecimento do espaço de trabalho",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o OpWrk está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o OpWrk. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao OpWrk — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no OpWrk. Baixe-o para abrir em outro aplicativo.",
  "filesView.artifact.document": "Documento",
  "filesView.artifact.spreadsheet": "Planilha",
  "filesView.artifact.presentation": "Apresentação",
  "filesView.artifact.readyTitle": "Pronto para abrir: {type}",
  "filesView.csv.empty": "Não há linhas para visualizar.",
  "filesView.csv.previewLimited": "A visualização é limitada. Mude para o modo de edição para ver o CSV completo.",
  "filesView.artifact.readyDescription": "O OpWrk salvou este entregável no seu espaço de trabalho. Abra-o em um aplicativo compatível para revisar ou editar.",
  "filesView.artifact.openDefaultApp": "Abrir no aplicativo padrão",
  "filesView.artifact.openFailed": "O OpWrk não conseguiu abrir este arquivo no aplicativo padrão.",
  ...
  "directoryExplorerDialog.title": "Adicionar pasta de espaço de trabalho",
  "directoryExplorerDialog.description": "Escolha uma pasta para usar como espaço de trabalho.",
  ...
  "directoryExplorerDialog.actions.addProject": "Adicionar espaço de trabalho",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpWrk precisa acessar esta pasta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versão do OpWrk {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OpWrk, a integridade do OpenCode, diretórios e projetos.",
  "aboutDialog.footerNote": "Feito com amor para quem ama o que faz.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo OpWrk com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do OpWrk",
  "header.actions.openAppMenuAria": "Abrir menu do OpWrk",
  ...
  "chat.draftPresets.research.label": "Pesquisar um tema",
  "chat.draftPresets.analyzeFiles.label": "Analisar arquivos",
  "chat.draftPresets.createDocument.label": "Criar um documento",
  "chat.draftPresets.createSpreadsheet.label": "Criar uma planilha",
  "chat.draftPresets.createPresentation.label": "Criar uma apresentação",
  "chat.draftPresets.createImage.label": "Criar uma imagem",
  ...
  "chat.modelControls.agent.work": "Trabalhar",
  "chat.modelControls.agent.plan": "Planejar",
  ...
  "projects.sharedTrust.description": "{path} neste repositório define comandos que rodam nesta máquina. Confie uma vez e o OpWrk só perguntará de novo quando eles mudarem.",
  ...
  "projectActions.actions.chooseActionAria": "Escolher ação do espaço de trabalho",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o OpWrk de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do OpWrk",
  ...
  "multiRun.window.description": "Janela do OpWrk Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao OpWrk",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OpWrk não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do OpWrk. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OpWrk e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do OpWrk para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor OpWrk ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do OpWrk. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando OpWrk, mas não é compatível com esta versão do app. Atualize o OpWrk no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando OpWrk. Verifique se o endereço aponta para um servidor OpWrk.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando OpWrk. Verifique se o endereço aponta para um servidor OpWrk.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor OpWrk em \"{host}\" não é compatível com esta versão do app. Atualize o OpWrk no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O OpWrk não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando OpWrk...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um momento e recarregue a página.",
  "updateDialog.error.signatureRejected": "A atualização baixada foi rejeitada: a assinatura de código não corresponde a esta instalação. Isso costuma significar que a cópia em execução não foi instalada a partir de uma versão oficial assinada. Instale o OpWrk a partir de uma versão oficial e atualize novamente.",
  "updateDialog.error.updaterDisabled": "O atualizador parou após uma instalação com falha. Feche o OpWrk, abra-o de novo e tente atualizar outra vez.",
  "updateDialog.error.restartFailed": "Não foi possível reiniciar para instalar a atualização.",
  "updateDialog.error.restartUnavailable": "Instalar a atualização exige o aplicativo de desktop do OpWrk.",
  "mobileUpdate.toast.available.title": "Atualização do OpWrk disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o OpWrk aberto.",
  ...
  "openChamberLogo.aria.logo": "Logo do OpWrk",
