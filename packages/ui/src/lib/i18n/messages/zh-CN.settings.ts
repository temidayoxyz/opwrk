...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '从控制面板网址复制工作区 ID，并从浏览器开发者工具复制 auth Cookie。OpWrk 绝不会扫描浏览器 Cookie 存储。',
  ...
  'settings.window.description': 'OpWrk 设置窗口。',
  ...
  'settings.page.appearance.description': '自定义 OpWrk 的外观与体验。',
  ...
  'settings.remoteInstances.direct.title': '其他 OpWrk 服务器',
  'settings.remoteInstances.direct.description': '此应用可切换到的服务器。从另一台服务器导入配对链接，或通过地址添加。',
  'settings.remoteInstances.direct.addDialog.description': '通过 URL 添加另一个 OpWrk 服务器。适用于服务器已在运行且你拥有连接令牌的情况。',
  ...
  'settings.remoteInstances.direct.import.description': '粘贴来自另一个 OpWrk 服务器的连接链接。',
  'settings.remoteInstances.direct.import.placeholder': 'openchamber://connect?...',
  'settings.remoteInstances.direct.import.action': '导入链接',
  'settings.remoteInstances.direct.error.invalidConnectLink': '无效的 OpWrk 连接链接。',
  ...
  'settings.remoteInstances.clientAuth.description': '创建安全链接或令牌，让 OpWrk Desktop 可以连接到此服务器。',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '用另一台设备上的 OpWrk 应用扫描。一次性使用且会过期。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '在家和外出都可用。外出时流量经由 OpWrk Private Relay(端到端加密隧道)传输，无需配置。',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '用其他设备上的 OpWrk 应用扫描此二维码。',
  ...
  'settings.remoteInstances.page.field.modeHint': '托管式设置暂不可用。请连接到已在运行的 OpWrk 服务器。',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'OpWrk 在远程机器上使用的端口。留空则自动选择。',
  ...
  'settings.openchamber.about.title': '关于 OpWrk',
  ...
  'settings.skills.catalog.add.descriptionPrefix': '将 Git 仓库添加为新的目录来源。OpWrk 会扫描其中包含',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登录时启动 OpWrk',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登录时启动 OpWrk',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在后台启动应用且不打开窗口。可通过桌面状态图标打开。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 菜单栏中显示 OpWrk',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在菜单栏中显示 OpWrk',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重启应用。关闭后，OpWrk 不会创建菜单栏项目，也不会运行相关的会话、审批和用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '将 OpWrk 关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '关闭到系统托盘',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '关闭主窗口时，让 OpWrk 继续在系统托盘中运行；最小化仍会将窗口保留在任务栏。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'OpWrk 运行时保持电脑唤醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'OpWrk 运行时保持电脑唤醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpWrk 会在重启后要求输入密码，之后在登录会话过期时再次要求：12 小时后，或选择“信任此设备”后 7 天。留空可关闭登录。',
  ...
  'settings.openchamber.tools.title': 'OpWrk 工具',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OpWrk Web 工具',
  'settings.openchamber.tools.field.agentWebToolAria': '启用 OpWrk Web 工具',
  'settings.openchamber.tools.field.agentWebToolInfo': '让智能体在 OpWrk 浏览器面板中查看并操作页面：打开网址、读取内容、点击、输入、滚动，以及在移动端与桌面端布局之间切换。会为每个会话添加少量工具说明。在 OpenCode 重启后生效。',
  ...
  'settings.remoteInstances.page.description': '通过 SSH 连接到另一台机器，并在那里打开 OpWrk。',
  ...
  'settings.remoteInstances.page.section.remoteServer': '远程机器上的 OpWrk',
  'settings.remoteInstances.page.section.remoteServerDescription': '选择 SSH 连接后 OpWrk 的运行方式。',
  'settings.remoteInstances.page.section.mainTunnel': '从这台电脑访问',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'OpWrk 运行在远程机器上。这里的设置只决定这台电脑上通过 SSH 隧道通向它的地址。',
  'settings.remoteInstances.page.section.authentication': '认证',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH 和远程 OpWrk UI 的可选凭据。',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '当此应用为你启动 OpWrk 时，如何将它放到远程机器上。',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '请先指定远程端口。在“已在运行”模式下，OpWrk 需要知道服务器监听哪个端口。',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '也允许远程机器所在网络中的其他设备不经 SSH 隧道直接打开这个 OpWrk。必须设置界面密码。',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '该网络中的任何人都能访问远程 OpWrk，保护它的只有下面的界面密码。',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '请先设置界面密码。没有密码时，远程 OpWrk 会对该网络中的所有设备开放。',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '用于保护远程 OpWrk 界面的密码。OpWrk 会把它设置到为你启动的服务器上。',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '远程机器上已在运行的 OpWrk 服务器的密码，用于登录。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安装 OpWrk',
  'settings.remoteInstances.page.phase.updatingOpenChamber': '正在更新 OpWrk',
  ...
  'settings.providers.page.custom.field.apiKey.info': '保存在 OpenCode 认证中，而非 OpWrk。使用 {env:VAR_NAME} 可从环境变量读取密钥。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '密钥将直接发送给 OpenCode，不会被 OpWrk 存储。',
  ...
  'settings.github.page.flow.title': '授权 OpWrk',
  ...
  'settings.github.page.ghCli.fallbackDescription': '在 OpWrk 认证被移除时可作为备用',
  ...
  'settings.notifications.page.testNotification.body': '这是来自 OpWrk 的测试通知。',
  ...
  'settings.voice.page.tooltip.sttLocal': '在 OpWrk 服务器上本地转写。模型自动下载，无需 API 密钥。',
  'settings.voice.page.tooltip.localTts': '在 OpWrk 服务器上本地合成语音（英语使用 Kokoro；其他语言的模型在首次使用时下载）。无需 API 密钥。',
  ...
  'settings.page.integrations.description': '连接 GitHub 和 Linear，让 OpWrk 可以处理你的 issue 和拉取请求。',
} as const;
