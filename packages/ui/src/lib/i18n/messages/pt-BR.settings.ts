...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copie o ID da URL do painel e o cookie auth das ferramentas do navegador. O OpWrk nunca examina os cookies do navegador.',
  ...
  "settings.window.description": "Janela de configurações do OpWrk.",
  ...
  "settings.page.appearance.description": "Personalize a aparência e a sensação do OpWrk.",
  ...
  "settings.remoteInstances.direct.title": "Outros servidores OpWrk",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Adicione outro servidor OpWrk por URL. Use isto quando o servidor já estiver em execução e você tiver um token de conexão.",
  ...
  "settings.remoteInstances.direct.import.description": "Cole um link de conexão de outro servidor OpWrk.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Link de conexão do OpWrk inválido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crie um link ou token seguro para que o OpWrk Desktop possa se conectar a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrScanHint": "Escaneie com o app OpWrk no seu outro dispositivo. É de uso único e expira.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona em casa e fora. Fora de casa o tráfego passa pelo OpWrk Private Relay, um túnel criptografado de ponta a ponta. Sem configuração.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escaneie este código QR com o app OpWrk no seu outro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "A configuração gerenciada ainda não está disponível. Conecte-se a um servidor OpWrk que já esteja em execução.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Porta que o OpWrk usa na máquina remota. Deixe vazio para escolher automaticamente.",
  ...
  "settings.openchamber.about.title": "Sobre o OpWrk",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Adicione um repositório Git como nova origem de catálogo. O OpWrk escaneará para encontrar pastas que contenham",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar o OpWrk ao fazer login",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar o OpWrk ao fazer login",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar o OpWrk na barra de menus do macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar o OpWrk na barra de menus",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Exige reiniciar o aplicativo. Quando desativado, o OpWrk não cria o item da barra de menus nem executa as atualizações de sessões, aprovações e uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Fechar o OpWrk na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Fechar na bandeja do sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantém o OpWrk em execução na bandeja do sistema quando a janela principal é fechada. Ao minimizar, a janela permanece na barra de tarefas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Manter o computador ativo enquanto o OpWrk estiver em execução",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Manter o computador ativo enquanto o OpWrk estiver em execução",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "O OpWrk pede após reiniciar e depois quando a sessão expira: em 12 horas, ou 7 dias com Confiar neste dispositivo. Deixe vazio para desativar o login.",
  ...
  "settings.openchamber.tools.title": "Ferramentas do OpWrk",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Ferramenta OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Ativar a ferramenta OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permita que agentes vejam a página no painel de navegador do OpWrk e interajam com ela: abrir uma URL, ler o conteúdo, clicar, digitar, rolar e alternar entre layout móvel e desktop. Adiciona uma pequena descrição de ferramenta a cada sessão. Aplicado após reiniciar o OpenCode.",
  ...
  "settings.remoteInstances.page.description": "Conecte-se a outra máquina por SSH e abra o OpWrk lá.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpWrk na máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Escolha como o OpWrk deve rodar depois que o SSH conectar.",
  "settings.remoteInstances.page.section.mainTunnel": "Acesso a partir deste computador",
  "settings.remoteInstances.page.section.mainTunnelDescription": "O OpWrk roda na máquina remota. Estas opções controlam apenas o endereço neste computador que leva até ela pelo túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticação",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciais opcionais para SSH e para a interface de usuário do OpWrk remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Como o OpWrk deve ser colocado na máquina remota quando este app o inicia para você.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Defina primeiro uma porta remota. No modo “Já em execução”, o OpWrk precisa saber em qual porta o servidor escuta.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir que outros dispositivos da rede da máquina remota abram este OpWrk diretamente, sem o túnel SSH. É obrigatória uma senha da interface.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Qualquer pessoa nessa rede alcança o OpWrk remoto. Só a senha da interface abaixo o protege.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Defina primeiro uma senha da interface. Sem ela, o OpWrk remoto ficaria aberto a todos os dispositivos daquela rede.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Senha que protegerá a interface remota do OpWrk. O OpWrk a define no servidor que inicia para você.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Senha do servidor OpWrk que já está em execução na máquina remota, usada para entrar nele.",
  ...
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Atualizando OpWrk",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Armazenada na autenticação do OpenCode, não pelo OpWrk. Use {env:VAR_NAME} para ler uma chave do ambiente.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "As chaves são enviadas diretamente ao OpenCode e nunca são armazenadas no OpWrk.",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponível como alternativa se a autenticação do OpWrk for removida",
  ...
  "settings.notifications.page.testNotification.body": "Esta é uma notificação de teste do OpWrk.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcrição local no servidor do OpWrk. Os modelos são baixados automaticamente; não é necessária chave de API.",
  "settings.voice.page.tooltip.localTts": "Síntese local no servidor do OpWrk (Kokoro para inglês; modelos de outros idiomas são baixados no primeiro uso). Não requer chave de API.",
  ...
  'settings.page.integrations.description': 'Conecte o GitHub e o Linear para que o OpWrk possa trabalhar com suas issues e pull requests.',
} as const;
