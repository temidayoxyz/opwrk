...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': '더 빠르게 접근하려면 OpWrk를 설치하세요',
  'pwa.installPrompt.action': '설치',
  'pwa.installPrompt.dismiss': '닫기',
  'pwa.installPrompt.started': '설치가 시작되었습니다',
  'pwa.installPrompt.installed': 'OpWrk가 설치되었습니다',
  ...
  'mobile.connect.welcome.title': 'OpWrk에 연결',
  ...
  'mobile.connect.password.placeholder': 'OpWrk 비밀번호',
  ...
  'mobile.connect.scan.invalid': '이 QR 코드는 OpWrk 연결 코드가 아닙니다.',
  ...
  'mobile.connect.relay.badge': 'OpWrk Relay 경유',
  ...
  'mobile.connect.error.unreachable': '해당 OpWrk 서버에 연결할 수 없습니다.',
  ...
  'sessions.sidebar.header.actions.addProject': '작업 공간 추가',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'OpWrk 정보',
  ...
  'chat.chatInput.chooseProject': '작업 공간 선택',
  ...
  'sessions.sidebar.project.actions.projectMenu': '작업 공간 메뉴',
  'sessions.sidebar.project.actions.newSession': '새 세션',
  'sessions.sidebar.project.actions.closeProject': '작업 공간 닫기',
  ...
  'contextRail.surface.editor.description': '작업 공간 파일 탐색 및 편집',
  ...
  'walkthrough.blocked.serverUnsupported.description': '이 앱이 연결된 OpWrk 서버가 워크스루 API에 응답하지 않았습니다. 즉 앱보다 오래된 버전입니다. 서버를 1.18 이상으로 업데이트한 뒤 새로 고치세요.',
  ...
  'contextRail.surface.notes.description': '작업 공간의 노트, 작업, 계획, 에이전트 메모리',
  ...
  'contextRail.surface.notes': '작업 공간 지식',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 은(는) OpWrk가 실행 중인 컴퓨터에 있으며, 그곳으로의 연결을 열지 못했습니다. 이 화면에는 사용자 컴퓨터의 내용이 표시되지 않습니다.',
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 OpWrk가 실행 중인 컴퓨터에 있습니다. 열려면 데스크톱 앱이 필요합니다.',
  ...
  'contextPanel.browser.trustNotice': '여기서 여는 페이지는 OpWrk에 대한 전체 액세스 권한으로 실행됩니다 — 검사와 스크린샷에 필요합니다. 신뢰하는 사이트만 여세요: 악성 페이지가 데이터를 읽거나 사용자를 대신해 동작할 수 있습니다.',
  ...
  'filesView.editor.binaryFileDescription': '이 파일은 바이너리이므로 OpWrk에서 편집할 수 없습니다. 다른 앱으로 열려면 다운로드하세요.',
  'filesView.artifact.document': '문서',
  'filesView.artifact.spreadsheet': '스프레드시트',
  'filesView.artifact.presentation': '프레젠테이션',
  'filesView.artifact.readyTitle': '{type}을(를) 열 준비가 되었습니다',
  'filesView.csv.empty': '미리 볼 행이 없습니다.',
  'filesView.csv.previewLimited': '미리보기는 일부만 표시됩니다. 전체 CSV를 보려면 편집 모드로 전환하세요.',
  'filesView.artifact.readyDescription': 'OpWrk가 이 결과물을 작업 공간에 저장했습니다. 검토하거나 편집하려면 호환되는 앱에서 여세요.',
  'filesView.artifact.openDefaultApp': '기본 앱에서 열기',
  'filesView.artifact.openFailed': 'OpWrk가 이 파일을 기본 앱에서 열지 못했습니다.',
  ...
  'directoryExplorerDialog.title': '작업 공간 폴더 추가',
  'directoryExplorerDialog.description': '작업 공간으로 사용할 폴더를 선택하세요.',
  ...
  'directoryExplorerDialog.actions.addProject': '작업 공간 추가',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk에서 이 폴더에 접근해야 합니다.',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpWrk 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OpWrk 상태, OpenCode 상태, 디렉터리 및 프로젝트를 포함합니다.',
  'aboutDialog.footerNote': '자신의 일을 사랑하는 사람들을 위해 사랑을 담아 만들었습니다.',
  ...
  'helpDialog.description': '이 단축키로 OpWrk를 빠르게 탐색하세요',
  ...
  'header.actions.openAppMenu': 'OpWrk 메뉴',
  'header.actions.openAppMenuAria': 'OpWrk 메뉴 열기',
  ...
  'chat.draftPresets.research.label': '주제 조사',
  'chat.draftPresets.analyzeFiles.label': '파일 분석',
  'chat.draftPresets.createDocument.label': '문서 만들기',
  'chat.draftPresets.createSpreadsheet.label': '스프레드시트 만들기',
  'chat.draftPresets.createPresentation.label': '프레젠테이션 만들기',
  'chat.draftPresets.createImage.label': '이미지 만들기',
  ...
  'chat.modelControls.agent.work': '작업',
  'chat.modelControls.agent.plan': '계획',
  ...
  'projectActions.actions.chooseActionAria': '작업 공간 작업 선택',
  ...
  'sessionAuth.error.networkDescription': 'UI 세션을 확인할 수 없습니다. 로컬 네트워크의 다른 기기에서 OpWrk를 열고 있다면 데스크톱 앱에서 Desktop Network Access를 활성화하고 설정에 표시되는 LAN 주소를 사용하세요.',
  ...
  'sessionAuth.locked.unlockTitle': 'OpWrk 잠금 해제',
  ...
  'desktopHostSwitcher.description': '로컬과 원격 OpWrk 서버 간에 전환합니다',
  ...
  'multiRun.window.description': 'OpWrk 멀티런 창.',
  ...
  'onboarding.chooser.title': 'OpWrk에 오신 것을 환영합니다',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OpWrk가 OpenCode를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OpenCode는 OpWrk의 심장입니다. 먼저 설치하고 시작하세요.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OpWrk 설정에 저장하고 OpenCode 구성을 다시 로드합니다.',
  ...
  'onboarding.remoteConnection.description': '연결할 OpWrk 서버 주소를 입력하세요.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'URL이 OpWrk 서버를 가리키는지 확인하거나 서버 관리자에게 문의하세요.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '이 인스턴스는 다른 OpWrk 버전을 실행 중입니다. 연결할 수 있지만 문제가 있으면 양쪽 앱을 업데이트하세요.',
  'onboarding.remoteConnection.probe.incompatibleMessage': '서버에서 OpWrk가 실행 중이지만 이 앱 버전과 호환되지 않습니다. 서버의 OpWrk를 업데이트한 후 다시 시도하세요.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '서버가 응답했지만 OpWrk가 실행 중이 아닙니다. 주소가 OpWrk 서버를 가리키는지 확인하세요.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '"{host}"의 서버에서 OpWrk가 실행 중이 아닙니다. 주소가 OpWrk 서버를 가리키는지 확인하세요.',
  'onboarding.desktopRecovery.remoteIncompatible.title': '서버 업데이트 필요',
  'onboarding.desktopRecovery.remoteIncompatible.description': '"{host}"의 OpWrk 서버가 이 앱 버전과 호환되지 않습니다. 서버의 OpWrk를 업데이트한 후 다시 시도하세요.',
  ...
  'startup.initRecovery.description': 'OpWrk 초기화를 완료할 수 없습니다. 서버가 실행 중인지 확인한 뒤 다시 시도하세요.',
  ...
  'updateDialog.header.updating': 'OpWrk 업데이트 중…',
  ...
  'updateDialog.error.takingLonger': '업데이트가 예상보다 오래 걸립니다. 잠시 기다린 뒤 페이지를 새로고침하세요.',
  'updateDialog.error.signatureRejected': '다운로드한 업데이트가 거부되었습니다. 코드 서명이 이 설치본과 일치하지 않습니다. 보통 실행 중인 복사본이 공식 서명 릴리스에서 설치되지 않았다는 뜻입니다. 공식 릴리스에서 OpWrk를 설치한 뒤 다시 업데이트하세요.',
  'updateDialog.error.updaterDisabled': '설치에 실패하여 업데이터가 중지되었습니다. OpWrk를 종료했다가 다시 열고 업데이트를 재시도하세요.',
  'updateDialog.error.restartFailed': '업데이트를 설치하기 위한 재시작에 실패했습니다.',
  'updateDialog.error.restartUnavailable': '업데이트 설치에는 OpWrk 데스크톱 앱이 필요합니다.',
  'mobileUpdate.toast.available.title': 'OpWrk 업데이트 사용 가능',
  ...
  'opencodeUpdate.toast.upgrading.description': 'OpWrk를 열어 두세요.',
  ...
  'openChamberLogo.aria.logo': 'OpWrk 로고',
