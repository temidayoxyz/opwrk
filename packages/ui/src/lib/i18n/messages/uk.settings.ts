...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Скопіюйте ID робочого простору з URL панелі, а cookie auth з інструментів розробника браузера. OpWrk ніколи не сканує сховище cookie браузера.',
  ...
  "settings.window.description": "Вікно налаштувань OpWrk.",
  ...
  "settings.page.appearance.description": "Налаштуйте вигляд і відчуття OpWrk.",
  ...
  "settings.remoteInstances.direct.title": "Інші сервери OpWrk",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Додайте інший сервер OpWrk за URL. Використовуйте це, коли сервер уже запущений і у вас є токен підключення.",
  ...
  "settings.remoteInstances.direct.import.description": "Вставте посилання для підключення з іншого сервера OpWrk.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Недійсне посилання підключення OpWrk.",
  ...
  "settings.remoteInstances.clientAuth.description": "Створіть безпечне посилання або токен, щоб OpWrk Desktop міг підключитися до цього сервера.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "QR-код підключення OpWrk",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Збільшити QR-код",
  "settings.remoteInstances.clientAuth.qrScanHint": "Скануй це застосунком OpWrk на іншому пристрої. Одноразовий і має термін дії.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Працює вдома і поза домом. Поза домом трафік іде через OpWrk Private Relay — наскрізно зашифрований тунель. Нічого налаштовувати не треба.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Відскануйте цей QR-код застосунком OpWrk на іншому пристрої.",
  ...
  "settings.remoteInstances.page.field.modeHint": "Кероване налаштування поки недоступне. Підключіться до вже запущеного сервера OpWrk.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Порт, який OpWrk займе на віддаленій машині. Лишіть порожнім, щоб вибрався автоматично.",
  ...
  "settings.openchamber.about.title": "Про OpWrk",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Додати репозиторій Git як нове джерело каталогу. OpWrk просканує його на наявність папок, що містять",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Запускати OpWrk під час входу в систему",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Запускати OpWrk під час входу в систему",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Показувати OpWrk у смузі меню macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Показувати OpWrk у смузі меню",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Потребує перезапуску застосунку. Якщо вимкнено, OpWrk не створює елемент смуги меню та не запускає пов’язані оновлення сесій, запитів на підтвердження й використання.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Закривати OpWrk у системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Закривати в системний трей",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Залишає OpWrk запущеним у системному треї, коли головне вікно закрито. Під час згортання вікно залишається на панелі завдань.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Не давати комп’ютеру засинати, поки OpWrk запущено",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Не давати комп’ютеру засинати, поки OpWrk запущено",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "OpWrk попросить пароль після перезапуску, а потім коли сесія логіну спливе: через 12 годин або через 7 днів із «Довіряти цьому пристрою». Залиште порожнім, щоб вимкнути логін.",
  ...
  "settings.openchamber.tools.title": "Інструменти OpWrk",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Інструмент OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Увімкнути інструмент OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Дозвольте агентам переглядати сторінку в панелі браузера OpWrk і взаємодіяти з нею: відкривати URL, читати вміст, клікати, вводити текст, гортати та перемикатися між мобільним і десктопним виглядом. Додає невеликий опис інструмента до кожної сесії. Застосовується після перезапуску OpenCode.",
  ...
  "settings.remoteInstances.page.description": "Підключіться до іншої машини через SSH і відкрийте там OpWrk.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpWrk на віддаленій машині",
  "settings.remoteInstances.page.section.remoteServerDescription": "Виберіть, як OpWrk має працювати після SSH-підключення.",
  "settings.remoteInstances.page.section.mainTunnel": "Доступ із цього комп’ютера",
  "settings.remoteInstances.page.section.mainTunnelDescription": "OpWrk працює на віддаленій машині. Ці налаштування керують лише адресою на цьому комп’ютері, яка веде до неї через SSH-тунель.",
  "settings.remoteInstances.page.section.authentication": "Аутентифікація",
  "settings.remoteInstances.page.section.authenticationDescription": "Додаткові облікові дані для SSH та віддаленого інтерфейсу користувача OpWrk.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Як розмістити OpWrk на віддаленій машині, коли цей застосунок запускає його для вас.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Спершу вкажіть віддалений порт. У режимі «Вже запущено» OpWrk має знати, на якому порту слухає сервер.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Дозволити іншим пристроям у мережі віддаленої машини відкривати цей OpWrk напряму, без SSH-тунелю. Потрібен пароль UI.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Будь-хто в тій мережі зможе дістатись віддаленого OpWrk. Його захищає лише пароль UI нижче.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Спершу задайте пароль UI. Без нього віддалений OpWrk буде відкритий для всіх пристроїв у тій мережі.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Пароль, яким буде захищено віддалений інтерфейс OpWrk. OpWrk задасть його серверу, який запускає для вас.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Пароль сервера OpWrk, який уже працює на віддаленій машині, для входу в нього.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Встановлення OpWrk",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Оновлення OpWrk",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Зберігається в автентифікації OpenCode, не OpWrk. Використовуйте {env:VAR_NAME}, щоб читати ключ зі змінної середовища.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключі надсилаються безпосередньо до OpenCode і ніколи не зберігаються в OpWrk.",
  ...
  "settings.github.page.flow.title": "Авторизувати OpWrk",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Доступно як резервний варіант, якщо автентифікацію OpWrk видалено",
  ...
  "settings.notifications.page.testNotification.body": "Це тестове сповіщення від OpWrk.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Локальна розшифровка на сервері OpWrk. Моделі завантажуються автоматично; ключ API не потрібен.",
  "settings.voice.page.tooltip.localTts": "Локальний синтез на сервері OpWrk (Kokoro для англійської; моделі для інших мов завантажуються при першому використанні). Ключ API не потрібен.",
  ...
  'settings.page.integrations.description': 'Підключіть GitHub і Linear, щоб OpWrk міг працювати з вашими задачами та pull request-ами.',
} as const;
