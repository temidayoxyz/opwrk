...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': '連線至 OpWrk',
  ...
  'mobile.connect.password.placeholder': 'OpWrk 密碼',
  ...
  'mobile.connect.scan.invalid': '此 QR code 不是 OpWrk 連線代碼。',
  ...
  'mobile.connect.relay.badge': '透過 OpWrk Relay 連線',
  ...
  'mobile.connect.error.unreachable': '無法連線至該 OpWrk 伺服器。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此實例正在執行不同版本的 OpWrk。你可以連線；如果功能異常，請更新兩端應用程式。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '伺服器正在執行 OpWrk，但與此應用程式版本不相容。請更新伺服器上的 OpWrk 後重試。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新伺服器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」上的 OpWrk 伺服器與此應用程式版本不相容。請更新伺服器上的 OpWrk 後重試。',
  ...
  'sessions.sidebar.header.actions.addProject': '新增工作區',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '關於 OpWrk',
  ...
  'chat.chatInput.chooseProject': '選擇工作區',
  ...
  'sessions.sidebar.project.actions.projectMenu': '工作區選單',
  'sessions.sidebar.project.actions.newSession': '新增會話',
  'sessions.sidebar.project.actions.closeProject': '關閉工作區',
  ...
  'contextRail.surface.editor.description': '瀏覽及編輯工作區檔案',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此應用程式連線的 OpWrk 伺服器沒有回應 walkthrough API，代表它比應用程式更舊。請將伺服器升級到 1.18 或更新版本後重新整理。',
  ...
  'contextRail.surface.notes.description': '工作區的筆記、任務、計畫與代理記憶',
  ...
  'contextRail.surface.notes': '工作區知識',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 執行在 OpWrk 所在的機器上，無法與其建立連線。這裡不會顯示你本機上的任何內容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 OpWrk 的那台機器上。要開啟它們需要桌面應用程式。',
  ...
  'contextPanel.browser.trustNotice': '在此開啟的頁面以對 OpWrk 的完整存取權限執行 — 檢查與截圖需要此權限。僅開啟你信任的網站：惡意頁面可能讀取你的資料或以你的身分執行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此檔案為二進位檔案，無法在 OpWrk 中編輯。請下載後使用其他應用程式開啟。',
  'filesView.artifact.document': '文件',
  'filesView.artifact.spreadsheet': '試算表',
  'filesView.artifact.presentation': '簡報',
  'filesView.artifact.readyTitle': '{type}已可開啟',
  'filesView.csv.empty': '沒有可預覽的列。',
  'filesView.csv.previewLimited': '預覽內容有限。切換至編輯模式以查看完整的 CSV 檔案。',
  'filesView.artifact.readyDescription': 'OpWrk 已將此成果儲存到你的工作區。請在相容的應用程式中開啟以檢視或編輯。',
  'filesView.artifact.openDefaultApp': '在預設應用程式中開啟',
  'filesView.artifact.openFailed': 'OpWrk 無法在預設應用程式中開啟此檔案。',
  ...
  'directoryExplorerDialog.title': '新增工作區資料夾',
  'directoryExplorerDialog.description': '選擇一個資料夾作為工作區。',
  ...
  'directoryExplorerDialog.actions.addProject': '新增工作區',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk 需要存取此資料夾。',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpWrk 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpWrk 狀態、OpenCode 健康資訊、目錄和專案。',
  'aboutDialog.footerNote': '為熱愛工作的人用心打造。',
  ...
  'helpDialog.description': '使用這些快速鍵可更有效率地導覽 OpWrk',
  ...
  'header.actions.openAppMenu': 'OpWrk 選單',
  'header.actions.openAppMenuAria': '開啟 OpWrk 選單',
  ...
  'chat.draftPresets.research.label': '研究主題',
  'chat.draftPresets.analyzeFiles.label': '分析檔案',
  'chat.draftPresets.createDocument.label': '建立文件',
  'chat.draftPresets.createSpreadsheet.label': '建立試算表',
  'chat.draftPresets.createPresentation.label': '建立簡報',
  'chat.draftPresets.createImage.label': '建立圖像',
  ...
  'chat.modelControls.agent.work': '工作',
  'chat.modelControls.agent.plan': '規劃',
  ...
  'projects.sharedTrust.description': '此儲存庫中的 {path} 定義了會在本機執行的命令。信任一次後，只有當命令變更時 OpWrk 才會再次詢問。',
  ...
  'projectActions.actions.chooseActionAria': '選擇工作區操作',
  ...
  'sessionAuth.error.networkDescription': '無法驗證 UI 會話。如果你是從本機網路中的其他裝置開啟 OpWrk，請在桌面應用程式中啟用 Desktop Network Access，並使用設定中顯示的 LAN 位址。',
  ...
  'sessionAuth.locked.unlockTitle': '解鎖 OpWrk',
  ...
  'desktopHostSwitcher.description': '在 Local 與遠端 OpWrk 伺服器之間切換',
  ...
  'multiRun.window.description': 'OpWrk 多執行視窗。',
  ...
  'onboarding.chooser.title': '歡迎使用 OpWrk',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpWrk 未自動偵測到 OpenCode，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpWrk 的核心，先安裝它即可開始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OpWrk 設定並重新載入 OpenCode 設定。',
  ...
  'onboarding.remoteConnection.description': '輸入要連接的 OpWrk 伺服器位址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建議：確認 URL 指向 OpWrk 伺服器，或聯絡伺服器管理員。',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': '伺服器有回應，但未執行 OpWrk。請確認位址是否指向 OpWrk 伺服器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」上的伺服器未執行 OpWrk。請確認位址是否指向 OpWrk 伺服器。',
  ...
  'startup.initRecovery.description': 'OpWrk 未能完成初始化。請檢查伺服器是否正在執行，然後重試。',
  ...
  'updateDialog.header.updating': '正在更新 OpWrk...',
  ...
  'updateDialog.error.takingLonger': '更新耗時超出預期。請稍候片刻，然後重新整理頁面。',
  'updateDialog.error.signatureRejected': '下載的更新遭到拒絕：其程式碼簽章與目前的安裝不符。這通常表示執行中的副本不是從官方簽章版本安裝的。請從官方版本安裝 OpWrk，再重新更新。',
  'updateDialog.error.updaterDisabled': '一次安裝失敗後，更新程式已停止。請結束 OpWrk，重新開啟後再試一次更新。',
  'updateDialog.error.restartFailed': '無法重新啟動以安裝更新。',
  'updateDialog.error.restartUnavailable': '安裝更新需要 OpWrk 桌面應用程式。',
  'mobileUpdate.toast.available.title': 'OpWrk 更新可用',
  ...
  'opencodeUpdate.toast.upgrading.description': '請保持 OpWrk 開啟。',
  ...
  'openChamberLogo.aria.logo': 'OpWrk 標誌',
