...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': 'OpWrk に接続',
  ...
  'mobile.connect.password.placeholder': 'OpWrk のパスワード',
  ...
  'mobile.connect.relay.badge': 'OpWrk Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その OpWrk サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは OpWrk の接続コードではありません。',
  ...
  'sessions.sidebar.header.actions.addProject': 'ワークスペースを追加',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'OpWrkについて',
  ...
  'chat.chatInput.chooseProject': 'ワークスペースを選択',
  ...
  'sessions.sidebar.project.actions.projectMenu': 'ワークスペースメニュー',
  'sessions.sidebar.project.actions.newSession': '新しいセッション',
  'sessions.sidebar.project.actions.closeProject': 'ワークスペースを閉じる',
  ...
  'contextRail.surface.editor.description': 'ワークスペースのファイルを表示・編集',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している OpWrk サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextRail.surface.notes.description': 'ワークスペースのメモ、タスク、プラン、エージェントのメモリ',
  ...
  'contextRail.surface.notes': 'ワークスペースナレッジ',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は OpWrk が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは OpWrk を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページはOpWrkへの完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、OpWrkでは編集できません。別のアプリで開くにはダウンロードしてください。',
  'filesView.artifact.document': 'ドキュメント',
  'filesView.artifact.spreadsheet': 'スプレッドシート',
  'filesView.artifact.presentation': 'プレゼンテーション',
  'filesView.artifact.readyTitle': '{type}を開く準備ができました',
  'filesView.csv.empty': 'プレビューする行がありません。',
  'filesView.csv.previewLimited': 'プレビューは一部のみです。CSV 全体を表示するには編集モードに切り替えてください。',
  'filesView.artifact.readyDescription': 'OpWrk がこの成果物をワークスペースに保存しました。確認または編集するには、対応するアプリで開いてください。',
  'filesView.artifact.openDefaultApp': '既定のアプリで開く',
  'filesView.artifact.openFailed': 'OpWrk はこのファイルを既定のアプリで開けませんでした。',
  ...
  'directoryExplorerDialog.title': 'ワークスペースフォルダを追加',
  'directoryExplorerDialog.description': 'ワークスペースとして使用するフォルダを選択してください。',
  ...
  'directoryExplorerDialog.actions.addProject': 'ワークスペースを追加',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk がこのフォルダにアクセスする必要があります。',
  ...
  'aboutDialog.openChamberVersionLabel': 'OpWrk バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OpWrkの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
  'aboutDialog.footerNote': '仕事を愛する人たちへ、愛を込めて。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってOpWrkを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'OpWrkメニュー',
  'header.actions.openAppMenuAria': 'OpWrkメニューを開く',
  ...
  'chat.draftPresets.research.label': 'トピックを調査',
  'chat.draftPresets.analyzeFiles.label': 'ファイルを分析',
  'chat.draftPresets.createDocument.label': '文書を作成',
  'chat.draftPresets.createSpreadsheet.label': 'スプレッドシートを作成',
  'chat.draftPresets.createPresentation.label': 'プレゼンテーションを作成',
  'chat.draftPresets.createImage.label': '画像を作成',
  ...
  'chat.modelControls.agent.work': '作業',
  'chat.modelControls.agent.plan': '計画',
  ...
  'projectActions.actions.chooseActionAria': 'ワークスペースアクションを選択',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから OpWrk を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'OpWrkのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのOpWrkサーバーを切り替えます',
  ...
  'multiRun.window.description': 'OpWrkマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'OpWrkへようこそ',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OpWrkがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはOpWrkの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OpWrk設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'onboarding.remoteConnection.description': '接続するOpWrkサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがOpWrkサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのOpWrkを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはOpWrkを実行していますが、このアプリバージョンと互換性がありません。サーバーのOpWrkを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、OpWrkを実行していません。アドレスがOpWrkサーバーを指していることを確認してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはOpWrkを実行していません。アドレスがOpWrkサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のOpWrkサーバーはこのアプリバージョンと互換性がありません。サーバーのOpWrkを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'OpWrkが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'OpWrkを更新中...',
  ...
  'updateDialog.error.takingLonger': '更新に予想以上に時間がかかっています。しばらく待ってからページを再読み込みしてください。',
  'updateDialog.error.signatureRejected': 'ダウンロードした更新は拒否されました。コード署名がこのインストールと一致しません。通常は、実行中のコピーが公式の署名済みリリースからインストールされていないことを意味します。公式リリースから OpWrk をインストールし直してから、もう一度更新してください。',
  'updateDialog.error.updaterDisabled': 'インストールに失敗したため、アップデーターが停止しました。OpWrk を終了して開き直し、更新をやり直してください。',
  'updateDialog.error.restartFailed': '更新をインストールするための再起動に失敗しました。',
  'updateDialog.error.restartUnavailable': '更新のインストールには OpWrk デスクトップアプリが必要です。',
  'mobileUpdate.toast.available.title': 'OpWrkの更新があります',
  ...
  'opencodeUpdate.toast.upgrading.description': 'OpWrkを開いたままにしてください。',
  ...
  'openChamberLogo.aria.logo': 'OpWrkロゴ',
