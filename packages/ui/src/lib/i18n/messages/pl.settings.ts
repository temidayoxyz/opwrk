...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Skopiuj ID z adresu panelu i cookie auth z narzędzi deweloperskich przeglądarki. OpWrk nigdy nie skanuje plików cookie przeglądarki.',
  ...
  'settings.github.page.flow.title': 'Autoryzuj OpWrk',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Dostępne jako rezerwa, jeśli uwierzytelnienie OpWrk zostanie usunięte',
  ...
  'settings.notifications.page.testNotification.body': 'To jest powiadomienie testowe z OpWrk.',
  ...
  'settings.openchamber.about.title': 'O OpWrk',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Uruchamiaj OpWrk przy logowaniu',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Uruchamiaj OpWrk przy logowaniu',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Pokazuj OpWrk na pasku menu macOS',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Pokazuj OpWrk na pasku menu',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Wymaga ponownego uruchomienia aplikacji. Po wyłączeniu OpWrk nie tworzy elementu paska menu ani nie uruchamia aktualizacji sesji, zatwierdzeń i użycia.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Zamykaj OpWrk do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Zamykaj do zasobnika systemowego',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Utrzymuje OpWrk w zasobniku systemowym, gdy główne okno zostanie zamknięte. Minimalizacja pozostawia okno na pasku zadań.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Utrzymuj komputer aktywny, gdy OpWrk jest uruchomiony',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Utrzymuj komputer aktywny, gdy OpWrk jest uruchomiony',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpWrk pyta po restarcie, a potem po wygaśnięciu sesji logowania: po 12 godzinach albo po 7 dniach z opcją Zaufaj temu urządzeniu. Zostaw puste, aby wyłączyć logowanie.',
  ...
  'settings.openchamber.tools.title': 'Narzędzia OpWrk',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'Narzędzie OpWrk Web',
  'settings.openchamber.tools.field.agentWebToolAria': 'Włącz narzędzie OpWrk Web',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Pozwól agentom oglądać stronę w panelu przeglądarki OpWrk i wchodzić z nią w interakcję: otwierać adres URL, czytać treść, klikać, pisać, przewijać i przełączać między układem mobilnym a desktopowym. Dodaje krótki opis narzędzia do każdej sesji. Zastosowane po ponownym uruchomieniu OpenCode.',
  ...
  'settings.page.appearance.description': 'Dostosuj wygląd i odczucie OpWrk.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Klucze są wysyłane bezpośrednio do OpenCode i nigdy nie są przechowywane przez OpWrk.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Przechowywany w auth OpenCode, nie przez OpWrk. Użyj {env:VAR_NAME}, aby odczytać klucz ze zmiennej środowiskowej.',
  ...
  'settings.remoteInstances.page.description': 'Połącz się z inną maszyną przez SSH i otwórz tam OpWrk.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'Jak OpWrk ma zostać umieszczony na zdalnej maszynie, gdy aplikacja uruchamia go za Ciebie.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Konfiguracja zarządzana nie jest jeszcze dostępna. Połącz się z już uruchomionym serwerem OpWrk.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port, którego OpWrk używa na zdalnej maszynie. Zostaw puste, aby wybrać automatycznie.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Najpierw podaj port zdalny. W trybie „Już uruchomiony” OpWrk musi wiedzieć, na którym porcie nasłuchuje serwer.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Pozwól innym urządzeniom w sieci zdalnej maszyny otwierać ten OpWrk bezpośrednio, bez tunelu SSH. Wymagane jest hasło interfejsu.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Każdy w tej sieci dotrze do zdalnego OpWrk. Chroni go tylko hasło interfejsu poniżej.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Najpierw ustaw hasło interfejsu. Bez niego zdalny OpWrk byłby otwarty dla każdego urządzenia w tej sieci.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Hasło chroniące zdalny interfejs OpWrk. OpWrk ustawia je na serwerze, który uruchamia za Ciebie.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Hasło serwera OpWrk już działającego na zdalnej maszynie, używane do zalogowania się.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Instalowanie OpWrk',
  ...
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Aktualizowanie OpWrk',
  ...
  'settings.remoteInstances.page.section.authenticationDescription': 'Opcjonalne dane logowania dla SSH i zdalnego interfejsu OpWrk.',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'OpWrk działa na zdalnej maszynie. Te ustawienia dotyczą wyłącznie adresu na tym komputerze, który prowadzi do niej przez tunel SSH.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpWrk na zdalnej maszynie',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Wybierz, jak OpWrk ma działać po połączeniu SSH.',
  ...
  'settings.remoteInstances.direct.title': 'Inne serwery OpWrk',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Dodaj inny serwer OpWrk przez URL. Użyj tego, gdy serwer już działa i masz token połączenia.',
  ...
  'settings.remoteInstances.direct.import.description': 'Wklej link połączenia z innego serwera OpWrk.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Nieprawidłowy link połączenia OpWrk.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Utwórz bezpieczny link lub token, aby OpWrk Desktop mógł połączyć się z tym serwerem.',
  ...
  'settings.remoteInstances.clientAuth.qrAlt': 'Kod QR połączenia OpWrk',
  'settings.remoteInstances.clientAuth.qrEnlarge': 'Powiększ kod QR',
  'settings.remoteInstances.clientAuth.qrScanHint': 'Zeskanuj to aplikacją OpWrk na drugim urządzeniu. Jednorazowy i wygasa.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Działa w domu i poza nim. Poza domem ruch przechodzi przez OpWrk Private Relay — szyfrowany end-to-end tunel. Bez konfiguracji.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Zeskanuj ten kod QR aplikacją OpWrk na drugim urządzeniu.',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Dodaj repozytorium Git jako nowe źródło katalogu. OpWrk przeskanuje je w poszukiwaniu folderów zawierających',
  ...
  'settings.voice.page.tooltip.sttLocal': 'Transkrypcja lokalna na serwerze OpWrk. Modele pobierają się automatycznie; klucz API nie jest potrzebny.',
  'settings.voice.page.tooltip.localTts': 'Lokalna synteza na serwerze OpWrk (Kokoro dla angielskiego; modele innych języków pobierane przy pierwszym użyciu). Klucz API nie jest potrzebny.',
  ...
  'settings.window.description': 'Okno ustawień OpWrk.',
  ...
  'settings.page.integrations.description': 'Połącz GitHub i Linear, aby OpWrk mógł pracować z Twoimi issue i pull requestami.',
};
