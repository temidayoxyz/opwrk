...
export const dict = {
  ...
  'sessions.sidebar.header.actions.addProject': 'Ajouter un espace de travail',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'À propos de OpWrk',
  ...
  'chat.chatInput.chooseProject': 'Choisir un espace de travail',
  ...
  'sessions.sidebar.project.actions.projectMenu': 'Menu de l’espace de travail',
  'sessions.sidebar.project.actions.newSession': 'Nouvelle session',
  'sessions.sidebar.project.actions.closeProject': 'Fermer l’espace de travail',
  ...
  'contextRail.surface.editor.description': 'Parcourir et modifier les fichiers de l’espace de travail',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur OpWrk auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'contextRail.surface.notes.description': 'Notes, tâches, plans et mémoire de l’agent pour l’espace de travail',
  ...
  'contextRail.surface.notes': 'Connaissances de l’espace de travail',
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans OpWrk. Téléchargez-le pour l’ouvrir avec une autre application.',
  'filesView.artifact.document': 'Document',
  'filesView.artifact.spreadsheet': 'Feuille de calcul',
  'filesView.artifact.presentation': 'Présentation',
  'filesView.artifact.readyTitle': 'Prêt à ouvrir : {type}',
  'filesView.csv.empty': 'Aucune ligne à prévisualiser.',
  'filesView.csv.previewLimited': 'L’aperçu est limité. Passez en mode édition pour voir tout le fichier CSV.',
  'filesView.artifact.readyDescription': 'OpWrk a enregistré ce livrable dans votre espace de travail. Ouvrez-le dans une application compatible pour le consulter ou le modifier.',
  'filesView.artifact.openDefaultApp': 'Ouvrir dans l’application par défaut',
  'filesView.artifact.openFailed': 'OpWrk n’a pas pu ouvrir ce fichier dans l’application par défaut.',
  ...
  'directoryExplorerDialog.title': 'Ajouter un dossier d’espace de travail',
  'directoryExplorerDialog.description': 'Choisissez un dossier à utiliser comme espace de travail.',
  ...
  'directoryExplorerDialog.actions.addProject': 'Ajouter un espace de travail',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk doit accéder à ce dossier.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Version OpWrk {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état OpWrk, l’état de santé OpenCode, les répertoires et les projets.',
  'aboutDialog.footerNote': 'Fait avec amour pour celles et ceux qui aiment leur travail.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans OpWrk',
  ...
  'header.actions.openAppMenu': 'Menu de OpWrk',
  'header.actions.openAppMenuAria': 'Ouvrir le menu OpWrk',
  ...
  'chat.modelControls.agent.work': 'Travailler',
  'chat.modelControls.agent.plan': 'Planifier',
  ...
  'projects.sharedTrust.description': '{path} dans ce dépôt définit des commandes qui s\'exécutent sur cette machine. Faites-leur confiance une fois, et OpWrk ne redemandera que si elles changent.',
  ...
  'projectActions.actions.chooseActionAria': 'Choisir l\'action de l’espace de travail',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez OpWrk depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez OpWrk',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs OpWrk locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution OpWrk.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur OpWrk',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si OpWrk ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de OpWrk — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres OpWrk et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur OpWrk auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur OpWrk ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas OpWrk. Vérifiez que l\'adresse pointe vers un serveur OpWrk.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas OpWrk. Vérifiez que l\'adresse pointe vers un serveur OpWrk.',
  ...
  'startup.initRecovery.description': 'OpWrk n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de OpWrk...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Patientez un moment, puis actualisez la page.',
  ...
  'updateDialog.error.updaterDisabled': 'Le programme de mise à jour s’est arrêté après une installation échouée. Quittez OpWrk, rouvrez-le, puis réessayez la mise à jour.',
  'updateDialog.error.restartFailed': 'Impossible de redémarrer pour installer la mise à jour.',
  'updateDialog.error.restartUnavailable': 'L’installation de la mise à jour nécessite l’application de bureau OpWrk.',
  'mobileUpdate.toast.available.title': 'Mise à jour OpWrk disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez OpWrk ouvert.',
  ...
  'openChamberLogo.aria.logo': 'Logo OpWrk',
  ...
  'mobile.connect.welcome.title': 'Se connecter à OpWrk',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe OpWrk',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion OpWrk.',
  ...
  'mobile.connect.relay.badge': 'via OpWrk Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur OpWrk.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve OpWrk, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge OpWrk. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à OpWrk — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'chat.draftPresets.research.label': 'Rechercher un sujet',
  'chat.draftPresets.analyzeFiles.label': 'Analyser des fichiers',
  'chat.draftPresets.createDocument.label': 'Créer un document',
  'chat.draftPresets.createSpreadsheet.label': 'Créer un tableur',
  'chat.draftPresets.createPresentation.label': 'Créer une présentation',
  'chat.draftPresets.createImage.label': 'Créer une image',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’OpWrk. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute OpWrk mais n’est pas compatible avec cette version de l’application. Mettez OpWrk à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur OpWrk à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez OpWrk à jour sur le serveur, puis réessayez.',
