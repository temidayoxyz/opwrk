...
export const dict: Record<I18nKey, string> = {
  ...
  'mobile.connect.welcome.title': '连接到 OpWrk',
  ...
  'mobile.connect.password.placeholder': 'OpWrk 密码',
  ...
  'mobile.connect.error.unreachable': '无法连接到该 OpWrk 服务器。',
  ...
  'sessions.sidebar.header.actions.addProject': '添加工作区',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': '关于 OpWrk',
  ...
  'chat.chatInput.chooseProject': '选择工作区',
  ...
  'sessions.sidebar.project.actions.projectMenu': '工作区菜单',
  'sessions.sidebar.project.actions.newSession': '新建会话',
  'sessions.sidebar.project.actions.closeProject': '关闭工作区',
  ...
  'contextRail.surface.editor.description': '浏览和编辑工作区文件',
  ...
  'walkthrough.blocked.serverUnsupported.description': '此应用连接的 OpWrk 服务器没有响应 walkthrough API，说明它比应用更旧。请将服务器升级到 1.18 或更高版本后刷新。',
  ...
  'contextRail.surface.notes.description': '工作区的笔记、任务、计划和智能体记忆',
  ...
  'contextRail.surface.notes': '工作区知识',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} 运行在 OpWrk 所在的机器上，无法与其建立连接。这里不会显示你本机上的任何内容。',
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 OpWrk 的那台机器上。要打开它们需要桌面应用。',
  ...
  'contextPanel.browser.trustNotice': '在此打开的页面以对 OpWrk 的完全访问权限运行 — 检查和截图需要此权限。仅打开你信任的站点：恶意页面可能读取你的数据或以你的身份执行操作。',
  ...
  'filesView.editor.binaryFileDescription': '此文件为二进制文件，无法在 OpWrk 中编辑。请下载后使用其他应用打开。',
  'filesView.artifact.document': '文档',
  'filesView.artifact.spreadsheet': '电子表格',
  'filesView.artifact.presentation': '演示文稿',
  'filesView.artifact.readyTitle': '{type}已可打开',
  'filesView.csv.empty': '没有可预览的行。',
  'filesView.csv.previewLimited': '预览内容有限。切换到编辑模式以查看完整的 CSV 文件。',
  'filesView.artifact.readyDescription': 'OpWrk 已将此成果保存到你的工作区。请在兼容的应用中打开以查看或编辑。',
  'filesView.artifact.openDefaultApp': '在默认应用中打开',
  'filesView.artifact.openFailed': 'OpWrk 无法在默认应用中打开此文件。',
  ...
  'directoryExplorerDialog.title': '添加工作区文件夹',
  'directoryExplorerDialog.description': '选择一个文件夹作为工作区。',
  ...
  'directoryExplorerDialog.actions.addProject': '添加工作区',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk 需要访问此文件夹。',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OpWrk 状态、OpenCode 健康信息、目录和项目。',
  'aboutDialog.footerNote': '为热爱工作的人用心打造。',
  ...
  'helpDialog.description': '使用这些快捷键可更高效地导航 OpWrk',
  ...
  'header.actions.openAppMenu': 'OpWrk 菜单',
  'header.actions.openAppMenuAria': '打开 OpWrk 菜单',
  ...
  'chat.draftPresets.research.label': '研究一个主题',
  'chat.draftPresets.analyzeFiles.label': '分析文件',
  'chat.draftPresets.createDocument.label': '创建文档',
  'chat.draftPresets.createSpreadsheet.label': '创建电子表格',
  'chat.draftPresets.createPresentation.label': '创建演示文稿',
  'chat.draftPresets.createImage.label': '创建图像',
  ...
  'chat.modelControls.agent.plan': '规划',
  ...
  'projects.sharedTrust.description': '此仓库中的 {path} 定义了会在本机运行的命令。信任一次后，只有当命令变更时 OpWrk 才会再次询问。',
  ...
  'projectActions.actions.chooseActionAria': '选择工作区操作',
  ...
  'sessionAuth.error.networkDescription': '无法验证 UI 会话。如果你是从本地网络中的另一台设备打开 OpWrk，请在桌面端应用中启用 Desktop Network Access，并使用设置中显示的 LAN 地址。',
  ...
  'sessionAuth.locked.unlockTitle': '解锁 OpWrk',
  ...
  'desktopHostSwitcher.description': '在 Local 与远程 OpWrk 服务器之间切换',
  ...
  'multiRun.window.description': 'OpWrk 多运行窗口。',
  ...
  'onboarding.chooser.title': '欢迎使用 OpWrk',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OpWrk 未自动检测到 OpenCode，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OpenCode 是 OpWrk 的核心，先安装它即可开始。',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OpWrk 设置并重新加载 OpenCode 配置。',
  ...
  'onboarding.remoteConnection.description': '输入要连接的 OpWrk 服务器地址。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': '建议：确认 URL 指向 OpWrk 服务器，或联系服务器管理员。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': '此实例正在运行不同版本的 OpWrk。你可以连接；如果功能异常，请更新两端应用。',
  'onboarding.remoteConnection.probe.incompatibleMessage': '服务器正在运行 OpWrk，但与此应用版本不兼容。请更新服务器上的 OpWrk 后重试。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': '服务器有响应，但未运行 OpWrk。请确认地址是否指向 OpWrk 服务器。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '“{host}” 上的服务器未运行 OpWrk。请确认地址是否指向 OpWrk 服务器。',
  'onboarding.desktopRecovery.remoteIncompatible.title': '需要更新服务器',
  'onboarding.desktopRecovery.remoteIncompatible.description': '“{host}” 上的 OpWrk 服务器与此应用版本不兼容。请更新服务器上的 OpWrk 后重试。',
  ...
  'startup.initRecovery.description': 'OpWrk 未能完成初始化。请检查服务器是否正在运行，然后重试。',
  ...
  'updateDialog.error.takingLonger': '更新耗时超出预期。请稍等片刻，然后刷新页面。',
  'updateDialog.error.signatureRejected': '下载的更新被拒绝：其代码签名与当前安装不匹配。这通常说明正在运行的副本不是从官方签名版本安装的。请从官方版本安装 OpWrk，然后再次更新。',
  'updateDialog.error.updaterDisabled': '一次安装失败后，更新程序已停止。请退出 OpWrk，重新打开后再试一次更新。',
  'updateDialog.error.restartFailed': '无法重启以安装更新。',
  'updateDialog.error.restartUnavailable': '安装更新需要 OpWrk 桌面应用。',
  ...
  'opencodeUpdate.toast.upgrading.description': '请保持 OpWrk 打开。',
  ...
  'openChamberLogo.aria.logo': 'OpWrk 标志',
