...
export const dict = {
  ...
  'mobile.connect.welcome.title': 'Connect to OpWrk',
  ...
  'mobile.connect.password.placeholder': 'OpWrk password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an OpWrk connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that OpWrk server.',
  ...
  'sessions.sidebar.header.actions.addProject': 'Add workspace',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'About OpWrk',
  ...
  'chat.chatInput.chooseProject': 'Choose workspace',
  ...
  'sessions.sidebar.project.actions.projectMenu': 'Workspace menu',
  'sessions.sidebar.project.actions.newSession': 'New session',
  'sessions.sidebar.project.actions.edit': 'Edit',
  'sessions.sidebar.project.actions.closeProject': 'Close workspace',
  ...
  'contextRail.surface.editor.description': 'Browse and edit workspace files',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The OpWrk server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextRail.surface.notes.description': 'Notes, tasks, plans, and agent memory for the workspace',
  ...
  'contextRail.surface.notes': 'Workspace knowledge',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine OpWrk is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting OpWrk. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to OpWrk — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in OpWrk. Download it to open with another app.',
  'filesView.artifact.document': 'Document',
  'filesView.artifact.spreadsheet': 'Spreadsheet',
  'filesView.artifact.presentation': 'Presentation',
  'filesView.artifact.readyTitle': '{type} ready to open',
  'filesView.csv.empty': 'No rows to preview.',
  'filesView.csv.previewLimited': 'Preview is limited. Switch to edit mode to see the complete CSV.',
  'filesView.artifact.readyDescription': 'OpWrk saved this deliverable in your workspace. Open it in a compatible app to review or edit it.',
  'filesView.artifact.openDefaultApp': 'Open in default app',
  'filesView.artifact.openFailed': 'OpWrk could not open this file in the default app.',
  ...
  'directoryExplorerDialog.title': 'Add workspace folder',
  'directoryExplorerDialog.description': 'Choose a folder to use as a workspace.',
  ...
  'directoryExplorerDialog.actions.addProject': 'Add workspace',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk needs access to this folder.',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OpWrk state, OpenCode health, directories, and projects.',
  'aboutDialog.footerNote': 'Made with love for those who love their work.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate OpWrk efficiently',
  ...
  'header.actions.openAppMenu': 'OpWrk menu',
  'header.actions.openAppMenuAria': 'Open OpWrk menu',
  ...
  'chat.draftPresets.research.label': 'Research a topic',
  'chat.draftPresets.analyzeFiles.label': 'Analyze files',
  'chat.draftPresets.createDocument.label': 'Create a document',
  'chat.draftPresets.createSpreadsheet.label': 'Build a spreadsheet',
  'chat.draftPresets.createPresentation.label': 'Make a presentation',
  'chat.draftPresets.createImage.label': 'Create an image',
  ...
  'chat.modelControls.agent.work': 'Work',
  'chat.modelControls.agent.plan': 'Plan',
  ...
  'projects.sharedTrust.description': '{path} in this repository defines commands that run on this machine. Trust them once, and OpWrk asks again only when they change.',
  ...
  'projectActions.actions.chooseActionAria': 'Choose workspace action',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening OpWrk from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock OpWrk',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote OpWrk servers',
  ...
  'multiRun.window.description': 'OpWrk Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to OpWrk',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OpWrk does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of OpWrk — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OpWrk settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an OpWrk server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an OpWrk server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different OpWrk version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running OpWrk but is not compatible with this app version. Update OpWrk on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running OpWrk. Verify the address points to an OpWrk server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running OpWrk. Verify the address points to an OpWrk server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The OpWrk server at "{host}" is not compatible with this app version. Update OpWrk on the server, then try again.',
  ...
  'startup.initRecovery.description': 'OpWrk could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating OpWrk...',
  ...
  'updateDialog.error.takingLonger': 'The update is taking longer than expected. Wait a moment, then refresh the page.',
  'updateDialog.error.signatureRejected': 'The downloaded update was rejected: its code signature does not match this installation. This usually means the running copy was not installed from an official signed release. Install OpWrk from an official release, then update again.',
  'updateDialog.error.updaterDisabled': 'The updater stopped after a failed install. Quit OpWrk, open it again, and retry the update.',
  'updateDialog.error.restartFailed': 'Could not restart to install the update.',
  'updateDialog.error.restartUnavailable': 'Installing the update requires the OpWrk desktop app.',
  'mobileUpdate.toast.available.title': 'OpWrk update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep OpWrk open.',
