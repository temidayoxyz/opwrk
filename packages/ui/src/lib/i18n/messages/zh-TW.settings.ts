...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': '從控制面板網址複製工作區 ID，並從瀏覽器開發者工具複製 auth Cookie。OpWrk 絕不會掃描瀏覽器 Cookie 儲存空間。',
  ...
  'settings.window.description': 'OpWrk 設定視窗。',
  ...
  'settings.page.appearance.description': '自訂 OpWrk 的外觀與體驗。',
  ...
  'settings.remoteInstances.direct.sidebarDescription': '連線到已在執行的 OpWrk 伺服器。',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': '用另一台裝置上的 OpWrk 應用程式掃描。一次性使用且會過期。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': '在家與外出都可用。外出時流量經由 OpWrk Private Relay(端對端加密隧道)傳輸，無需設定。',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': '用另一台裝置上的 OpWrk 應用程式掃描此 QR 碼。',
  ...
  'settings.remoteInstances.page.field.modeHint': '受管理的設定目前尚不可用。請連接至已在執行的 OpWrk 伺服器。',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'OpWrk 在遠端機器上使用的連接埠。留空則自動選擇。',
  ...
  'settings.openchamber.about.title': '關於 OpWrk',
  ...
  'settings.skills.catalog.add.descriptionPrefix': '將 Git 儲存庫新增為新的目錄來源。OpWrk 會掃描其中包含',
  ...
  'settings.openchamber.tools.field.agentWebToolAria': '啟用 OpWrk Web 工具',
  'settings.openchamber.tools.field.agentWebToolInfo': '讓代理在 OpWrk 瀏覽器面板中檢視並操作頁面：開啟網址、讀取內容、點擊、輸入、捲動，以及在行動版與桌面版版面之間切換。會為每個工作階段加入少量工具說明。在 OpenCode 重新啟動後生效。',
  ...
  'settings.remoteInstances.page.section.remoteServerDescription': 'OpWrk 在遠端主機上的管理與啟動方式。',
  'settings.remoteInstances.page.section.mainTunnel': '從這台電腦存取',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'OpWrk 執行在遠端機器上。這裡的設定只決定這台電腦上通往它的 SSH 隧道位址。',
  'settings.remoteInstances.page.section.authentication': '驗證',
  'settings.remoteInstances.page.section.authenticationDescription': 'SSH 和遠端 OpWrk UI 的可選憑證。',
  ...
  'settings.remoteInstances.page.field.installMethodHint': '在 managed 模式下 OpWrk 的安裝方式。',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': '請先指定遠端連接埠。在「已在執行」模式下，OpWrk 需要知道伺服器監聽哪個連接埠。',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': '也允許遠端機器所在網路中的其他裝置不經 SSH 隧道直接開啟這個 OpWrk。必須設定介面密碼。',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': '該網路中的任何人都能存取遠端 OpWrk，保護它的只有下面的介面密碼。',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': '請先設定介面密碼。沒有密碼時，遠端 OpWrk 會對該網路中的所有裝置開放。',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': '用來保護遠端 OpWrk 介面的密碼。OpWrk 會把它設定到為你啟動的伺服器上。',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': '遠端機器上已在執行的 OpWrk 伺服器的密碼，用於登入。',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': '正在安裝 OpWrk',
  ...
  'settings.providers.page.custom.field.apiKey.info': '儲存在 OpenCode 驗證中，而非 OpWrk。使用 {env:VAR_NAME} 可從環境變數讀取金鑰。',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '金鑰將直接送出給 OpenCode，不會由 OpWrk 儲存。',
  ...
  'settings.github.page.flow.title': '授權 OpWrk',
  ...
  'settings.github.page.ghCli.fallbackDescription': '在 OpWrk 認證被移除時可作為備用',
  ...
  'settings.notifications.page.testNotification.body': '這是來自 OpWrk 的測試通知。',
  ...
  'settings.voice.page.tooltip.sttLocal': '在 OpWrk 伺服器上本機轉寫。模型會自動下載，無需 API 金鑰。',
  'settings.voice.page.tooltip.localTts': '在 OpWrk 伺服器上本機合成語音（英文使用 Kokoro；其他語言的模型在首次使用時下載）。不需要 API 金鑰。',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLogin': '登入時自動啟動 OpWrk',
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': '登入時自動啟動 OpWrk',
  'settings.openchamber.desktopNetwork.field.launchAtLoginDescription': '在背景啟動應用程式，不開啟視窗。可透過桌面狀態圖示開啟。',
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': '在 macOS 選單列中顯示 OpWrk',
  'settings.openchamber.desktopNetwork.field.macMenuBar': '在選單列中顯示 OpWrk',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': '需要重新啟動應用程式。關閉後，OpWrk 不會建立選單列項目，也不會執行相關的工作階段、核准與用量更新。',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': '將 OpWrk 關閉到系統匣',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': '關閉到系統匣',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': '關閉主視窗時，讓 OpWrk 繼續在系統匣中執行；最小化仍會將視窗保留在工作列。',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'OpWrk 執行時保持電腦喚醒',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'OpWrk 執行時保持電腦喚醒',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpWrk 會在重新啟動後要求輸入密碼，之後會在登入工作階段過期時再次要求：12 小時後，或選擇「信任此裝置」後 7 天。留空可停用登入。',
  ...
  'settings.page.integrations.description': '連接 GitHub 和 Linear，讓 OpWrk 可以處理你的 issue 和 pull request。',
} as const;
