...
export const linearIntegrationI18n = {
  en: {
    ...
    'settings.integrations.firstParty.info': 'Sign-ins for services that ship with OpWrk. The login stays on this computer so web, desktop, and a paired phone share it.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Connect Linear workspaces on this OpWrk server.',
    'settings.integrations.linear.info': 'Connect one or more Linear workspaces. OpWrk stores the logins on this computer so web, desktop, and a paired phone share them.',
  ...
  de: {
    ...
    'settings.integrations.firstParty.info': 'Anmeldungen für Dienste, die mit OpWrk mitgeliefert werden. Die Anmeldung bleibt auf diesem Computer, damit Web, Desktop und ein gekoppeltes Telefon sie teilen.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Verbinde Linear-Workspaces mit diesem OpWrk-Server.',
    'settings.integrations.linear.info': 'Verbinde einen oder mehrere Linear-Workspaces. OpWrk speichert die Anmeldungen auf diesem Computer, damit Web, Desktop und ein gekoppeltes Telefon sie teilen.',
  ...
  fr: {
    ...
    'settings.integrations.firstParty.info': 'Connexions aux services fournis avec OpWrk. La connexion reste sur cet ordinateur pour que le web, le bureau et un téléphone apparié la partagent.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Connectez des espaces Linear à ce serveur OpWrk.',
    'settings.integrations.linear.info': 'Connectez un ou plusieurs espaces Linear. OpWrk enregistre les connexions sur cet ordinateur pour que le web, le bureau et un téléphone apparié les partagent.',
  ...
  es: {
    ...
    'settings.integrations.firstParty.info': 'Inicios de sesión de los servicios incluidos en OpWrk. El inicio de sesión se guarda en este ordenador para que la web, el escritorio y un teléfono emparejado lo compartan.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Conecta espacios de Linear a este servidor de OpWrk.',
    'settings.integrations.linear.info': 'Conecta uno o más espacios de Linear. OpWrk guarda los inicios de sesión en este ordenador para que la web, el escritorio y un teléfono emparejado los compartan.',
  ...
  ja: {
    ...
    'settings.integrations.firstParty.info': 'OpWrk に同梱されているサービスのログインです。このコンピュータに保存され、Web、デスクトップ、ペアリングしたスマホで共有されます。',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'この OpWrk サーバーに Linear ワークスペースを接続します。複数接続できます。',
  ...
  ko: {
    ...
    'settings.integrations.firstParty.info': 'OpWrk에 포함된 서비스 로그인입니다. 이 컴퓨터에 저장되며 웹, 데스크톱, 페어링된 휴대폰이 공유합니다.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '이 OpWrk 서버에 Linear 워크스페이스를 연결하세요. 여러 개를 연결할 수 있습니다.',
  ...
  pl: {
    ...
    'settings.integrations.firstParty.info': 'Logowania do usług dostarczanych z OpWrk. Zapisujemy je na tym komputerze, żeby przeglądarka, aplikacja desktopowa i sparowany telefon z nich korzystały.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Połącz przestrzenie Linear z tym serwerem OpWrk.',
    'settings.integrations.linear.info': 'Połącz jedną lub kilka przestrzeni Linear. OpWrk zapisuje logowania na tym komputerze, żeby przeglądarka, aplikacja desktopowa i sparowany telefon z nich korzystały.',
  ...
  'pt-BR': {
    ...
    'settings.integrations.firstParty.info': 'Logins dos serviços inclusos no OpWrk. O login fica neste computador para que a web, o app desktop e um celular emparelhado o compartilhem.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Conecte espaços do Linear a este servidor OpWrk.',
    'settings.integrations.linear.info': 'Conecte um ou mais espaços do Linear. O OpWrk guarda os logins neste computador para que a web, o app desktop e um celular emparelhado os compartilhem.',
  ...
  uk: {
    ...
    'settings.integrations.firstParty.info': 'Входи до сервісів, що входять до OpWrk. Логін лишається на цьому комп’ютері, тож веб, десктоп і спарений телефон користуються одним обліковим записом.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Підключіть Linear workspace до цього сервера OpWrk. Можна кілька.',
    'settings.integrations.linear.info': 'Підключіть один або кілька Linear workspace. OpWrk зберігає входи на цьому комп’ютері, тож веб, десктоп і спарений телефон користуються ними.',
  ...
  'zh-CN': {
    ...
    'settings.integrations.firstParty.info': 'OpWrk 自带服务的登录。登录保存在这台电脑上，网页、桌面应用和已配对的手机会共用它。',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '将 Linear 工作区连接到此 OpWrk 服务器。可以连接多个。',
    'settings.integrations.linear.info': '连接一个或多个 Linear 工作区。OpWrk 把登录保存在这台电脑上，网页、桌面应用和已配对的手机会共用它们。',
  ...
  'zh-TW': {
    ...
    'settings.integrations.firstParty.info': 'OpWrk 內建服務的登入。登入保存在這台電腦上，網頁、桌面應用程式和已配對的手機會共用它。',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': '將 Linear 工作區連線到此 OpWrk 伺服器。可以連線多個。',
    'settings.integrations.linear.info': '連接一個或多個 Linear 工作區。OpWrk 把登入保存在這台電腦上，網頁、桌面應用程式和已配對的手機會共用它們。',
  ...
  tr: {
    ...
    'settings.integrations.firstParty.info': 'OpWrk ile gelen hizmetlerin oturumları. Giriş bu bilgisayarda kalır; web, masaüstü ve eşlenen telefon paylaşır.',
    'settings.integrations.linear.title': 'Linear',
    'settings.integrations.linear.description': 'Linear çalışma alanlarını bu OpWrk sunucusuna bağla.',
    'settings.integrations.linear.info': 'Bir veya daha fazla Linear çalışma alanı bağla. OpWrk girişleri bu bilgisayarda tutar; web, masaüstü ve eşlenen telefon paylaşır.',
