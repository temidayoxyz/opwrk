...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. OpWrk never scans browser cookie storage.',
  ...
  'settings.window.description': 'OpWrk settings window.',
  ...
  'settings.page.appearance.description': 'Customize how OpWrk looks and feels.',
  ...
  'settings.remoteInstances.direct.title': 'Other OpWrk servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another OpWrk server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another OpWrk server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid OpWrk connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so OpWrk Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the OpWrk app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through OpWrk Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the OpWrk app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Managed setup is not available yet. Connect to an OpWrk server that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port OpWrk uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.openchamber.about.title': 'About OpWrk',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. OpWrk will scan it for folders containing',
  ...
  'settings.openchamber.desktopNetwork.field.launchAtLoginAria': 'Start OpWrk at login',
  'settings.openchamber.desktopNetwork.field.launchAtLogin': 'Start OpWrk when you log in',
  ...
  'settings.openchamber.desktopNetwork.field.macMenuBarAria': 'Show OpWrk in the macOS menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBar': 'Show OpWrk in the menu bar',
  'settings.openchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, OpWrk does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayAria': 'Close OpWrk to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.openchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OpWrk running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.openchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while OpWrk is running',
  'settings.openchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while OpWrk is running',
  ...
  'settings.openchamber.desktopPassword.field.passwordDescription': 'OpWrk asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  ...
  'settings.openchamber.tools.title': 'OpWrk Tools',
  ...
  'settings.openchamber.tools.field.agentWebTool': 'OpWrk Web tool',
  'settings.openchamber.tools.field.agentWebToolAria': 'Enable the OpWrk Web tool',
  'settings.openchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in OpWrk\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open OpWrk there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'OpWrk on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how OpWrk should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'OpWrk runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote OpWrk UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How OpWrk should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode OpWrk needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this OpWrk directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote OpWrk. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote OpWrk to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote OpWrk UI. OpWrk sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the OpWrk server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingOpenChamber': 'Installing OpWrk',
  'settings.remoteInstances.page.phase.updatingOpenChamber': 'Updating OpWrk',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by OpWrk. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by OpWrk.',
  ...
  'settings.github.page.flow.title': 'Authorize OpWrk',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if OpWrk auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from OpWrk.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the OpWrk server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the OpWrk server (Kokoro for English; models for other languages download on first use). No API key needed.',
  ...
  'settings.page.integrations.description': 'Connect GitHub and Linear so OpWrk can work with your issues and pull requests.',
} as const;
