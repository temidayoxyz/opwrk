...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj OpWrk, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'OpWrk został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z OpWrk',
  ...
  'mobile.connect.password.placeholder': 'Hasło OpWrk',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia OpWrk.',
  ...
  'mobile.connect.relay.badge': 'przez OpWrk Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem OpWrk.',
  ...
  'sessions.sidebar.header.actions.addProject': 'Dodaj obszar roboczy',
  ...
  'sessions.sidebar.footer.actions.aboutOpenChamber': 'O OpWrk',
  ...
  'chat.chatInput.chooseProject': 'Wybierz obszar roboczy',
  ...
  'sessions.sidebar.project.actions.projectMenu': 'Menu obszaru roboczego',
  'sessions.sidebar.project.actions.newSession': 'Nowa sesja',
  'sessions.sidebar.project.actions.closeProject': 'Zamknij obszar roboczy',
  ...
  'chat.draftPresets.research.label': 'Zbadaj temat',
  'chat.draftPresets.analyzeFiles.label': 'Przeanalizuj pliki',
  'chat.draftPresets.createDocument.label': 'Utwórz dokument',
  'chat.draftPresets.createSpreadsheet.label': 'Utwórz arkusz',
  'chat.draftPresets.createPresentation.label': 'Utwórz prezentację',
  'chat.draftPresets.createImage.label': 'Utwórz obraz',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia OpWrk.',
  ...
  'onboarding.chooser.title': 'Witaj w OpWrk',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OpWrk nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OpWrk i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera OpWrk aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer OpWrk, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji OpWrk. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia OpWrk, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpWrk na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim OpWrk. Zweryfikuj czy adres wskazuje na serwer OpWrk.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia OpWrk. Zweryfikuj czy adres wskazuje na serwer OpWrk.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer OpWrk pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj OpWrk na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'OpWrk nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OpWrk, kondycję OpenCode, katalogi i projekty.',
  'aboutDialog.footerNote': 'Stworzone z miłością dla tych, którzy kochają swoją pracę.',
  ...
  'aboutDialog.openChamberVersionLabel': 'Wersja OpWrk {version}',
  ...
  'chat.modelControls.agent.work': 'Praca',
  'chat.modelControls.agent.plan': 'Planowanie',
  ...
  'contextRail.surface.editor.description': 'Przeglądaj i edytuj pliki obszaru roboczego',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer OpWrk, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextRail.surface.notes.description': 'Notatki, zadania, plany i pamięć agenta dla obszaru roboczego',
  ...
  'contextRail.surface.notes': 'Wiedza o obszarze roboczym',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest OpWrk, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest OpWrk. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do OpWrk — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami OpWrk',
  ...
  'directoryExplorerDialog.actions.addProject': 'Dodaj obszar roboczy',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'OpWrk potrzebuje dostępu do tego folderu.',
  ...
  'directoryExplorerDialog.description': 'Wybierz folder, którego chcesz używać jako obszaru roboczego.',
  ...
  'directoryExplorerDialog.title': 'Dodaj folder obszaru roboczego',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w OpWrk. Pobierz go, aby otworzyć w innej aplikacji.',
  'filesView.artifact.document': 'Dokument',
  'filesView.artifact.spreadsheet': 'Arkusz kalkulacyjny',
  'filesView.artifact.presentation': 'Prezentacja',
  'filesView.artifact.readyTitle': 'Gotowe do otwarcia: {type}',
  'filesView.csv.empty': 'Brak wierszy do podglądu.',
  'filesView.csv.previewLimited': 'Podgląd jest ograniczony. Przełącz na tryb edycji, aby zobaczyć cały plik CSV.',
  'filesView.artifact.readyDescription': 'OpWrk zapisał ten rezultat w obszarze roboczym. Otwórz go w zgodnej aplikacji, aby go przejrzeć lub edytować.',
  'filesView.artifact.openDefaultApp': 'Otwórz w domyślnej aplikacji',
  'filesView.artifact.openFailed': 'OpWrk nie mógł otworzyć tego pliku w domyślnej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu OpWrk',
  'header.actions.openAppMenuAria': 'Otwórz menu OpWrk',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po OpWrk.',
  ...
  'projects.sharedTrust.description': '{path} w tym repozytorium definiuje polecenia uruchamiane na tym komputerze. Zaufaj raz, a OpWrk zapyta ponownie tylko wtedy, gdy się zmienią.',
  ...
  'projectActions.actions.chooseActionAria': 'Wybierz akcję obszaru roboczego',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz OpWrk z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj OpWrk',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę, a potem odśwież stronę.',
  'updateDialog.error.signatureRejected': 'Pobrana aktualizacja została odrzucona: jej podpis kodu nie pasuje do tej instalacji. Zwykle oznacza to, że uruchomiona kopia nie pochodzi z oficjalnego podpisanego wydania. Zainstaluj OpWrk z oficjalnego wydania i zaktualizuj ponownie.',
  'updateDialog.error.updaterDisabled': 'Aktualizator zatrzymał się po nieudanej instalacji. Zamknij OpWrk, otwórz go ponownie i spróbuj zaktualizować jeszcze raz.',
  'updateDialog.error.restartFailed': 'Nie udało się uruchomić ponownie, aby zainstalować aktualizację.',
  'updateDialog.error.restartUnavailable': 'Instalacja aktualizacji wymaga aplikacji desktopowej OpWrk.',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja OpWrk',
  ...
  'updateDialog.header.updating': 'Aktualizowanie OpWrk...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw OpWrk otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce OpWrk — zainstaluj je, aby zacząć.',
