...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copia el ID desde la URL del panel y la cookie auth desde las herramientas del navegador. OpWrk nunca examina las cookies del navegador.',
  ...
  "settings.window.description": "Ventana de configuración de OpWrk.",
  ...
  "settings.page.appearance.description": "Personaliza el aspecto y la sensación de OpWrk.",
  ...
  "settings.remoteInstances.direct.title": "Otros servidores de OpWrk",
  ...
  "settings.remoteInstances.direct.addDialog.description": "Añade otro servidor de OpWrk por URL. Úsalo cuando el servidor ya esté en marcha y tengas un token de conexión.",
  ...
  "settings.remoteInstances.direct.import.description": "Pega un enlace de conexión de otro servidor de OpWrk.",
  ...
  "settings.remoteInstances.direct.error.invalidConnectLink": "Enlace de conexión de OpWrk no válido.",
  ...
  "settings.remoteInstances.clientAuth.description": "Crea un enlace o token seguro para que OpWrk Desktop pueda conectarse a este servidor.",
  ...
  "settings.remoteInstances.clientAuth.qrAlt": "OpWrk connection QR code",
  "settings.remoteInstances.clientAuth.qrEnlarge": "Ampliar código QR",
  "settings.remoteInstances.clientAuth.qrScanHint": "Escanéalo con la app de OpWrk en tu otro dispositivo. Es de un solo uso y caduca.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.remoteInstances.clientAuth.addDevice.transport.relayHint": "Funciona en casa y fuera. Fuera de casa el tráfico pasa por OpWrk Private Relay, un túnel cifrado de extremo a extremo. Sin configuración.",
  ...
  "settings.remoteInstances.relay.pair.qrDialogDescription": "Escanea este código QR con la app de OpWrk en tu otro dispositivo.",
  ...
  "settings.remoteInstances.page.field.modeHint": "La configuración administrada aún no está disponible. Conéctate a un servidor OpWrk que ya esté en ejecución.",
  ...
  "settings.remoteInstances.page.field.preferredRemotePortHint": "Puerto que OpWrk usa en la máquina remota. Déjalo vacío para elegir uno automáticamente.",
  ...
  "settings.openchamber.about.title": "Acerca de OpWrk",
  ...
  "settings.skills.catalog.add.descriptionPrefix": "Añade un repositorio Git como nuevo origen de catálogo. OpWrk escaneará para encontrar carpetas que contengan",
  ...
  "settings.openchamber.desktopNetwork.field.launchAtLoginAria": "Iniciar OpWrk al iniciar sesión",
  "settings.openchamber.desktopNetwork.field.launchAtLogin": "Iniciar OpWrk al iniciar sesión",
  ...
  "settings.openchamber.desktopNetwork.field.macMenuBarAria": "Mostrar OpWrk en la barra de menús de macOS",
  "settings.openchamber.desktopNetwork.field.macMenuBar": "Mostrar OpWrk en la barra de menús",
  "settings.openchamber.desktopNetwork.field.macMenuBarDescription": "Requiere reiniciar la aplicación. Al desactivarlo, OpWrk no crea el elemento de la barra de menús ni ejecuta sus actualizaciones de sesiones, aprobaciones y uso.",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayAria": "Cerrar OpWrk a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTray": "Cerrar a la bandeja del sistema",
  "settings.openchamber.desktopNetwork.field.minimizeToTrayDescription": "Mantiene OpWrk en ejecución en la bandeja del sistema cuando se cierra la ventana principal. Al minimizar, la ventana sigue en la barra de tareas.",
  "settings.openchamber.desktopNetwork.field.keepAwakeAria": "Mantener el ordenador activo mientras OpWrk está en ejecución",
  "settings.openchamber.desktopNetwork.field.keepAwake": "Mantener el ordenador activo mientras OpWrk está en ejecución",
  ...
  "settings.openchamber.desktopPassword.field.passwordDescription": "OpWrk la pide después del reinicio y luego cuando vence la sesión: tras 12 horas, o 7 días con Confiar en este dispositivo. Déjalo vacío para desactivar el inicio de sesión.",
  ...
  "settings.openchamber.tools.title": "Herramientas de OpWrk",
  ...
  "settings.openchamber.tools.field.agentWebTool": "Herramienta OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolAria": "Activar la herramienta OpWrk Web",
  "settings.openchamber.tools.field.agentWebToolInfo": "Permite que los agentes vean la página en el panel de navegador de OpWrk e interactúen con ella: abrir una URL, leer el contenido, hacer clic, escribir, desplazarse y alternar entre diseño móvil y de escritorio. Añade una pequeña descripción de herramienta a cada sesión. Se aplica tras reiniciar OpenCode.",
  ...
  "settings.remoteInstances.page.description": "Conéctate a otra máquina por SSH y abre OpWrk allí.",
  ...
  "settings.remoteInstances.page.section.remoteServer": "OpWrk en la máquina remota",
  "settings.remoteInstances.page.section.remoteServerDescription": "Elige cómo debe ejecutarse OpWrk después de conectar por SSH.",
  "settings.remoteInstances.page.section.mainTunnel": "Acceso desde este equipo",
  "settings.remoteInstances.page.section.mainTunnelDescription": "OpWrk se ejecuta en la máquina remota. Estos ajustes solo controlan la dirección de este equipo que lleva hasta ella por el túnel SSH.",
  "settings.remoteInstances.page.section.authentication": "Autenticación",
  "settings.remoteInstances.page.section.authenticationDescription": "Credenciales opcionales para SSH y la interfaz de usuario de OpWrk remoto.",
  ...
  "settings.remoteInstances.page.field.installMethodHint": "Cómo debe colocarse OpWrk en la máquina remota cuando esta app lo inicia por ti.",
  ...
  "settings.remoteInstances.page.validation.externalPortRequired": "Primero indica un puerto remoto. En el modo «Ya está en ejecución», OpWrk necesita saber en qué puerto escucha el servidor.",
  ...
  "settings.remoteInstances.page.field.remoteLanAccessHint": "Permitir también que otros dispositivos de la red de la máquina remota abran este OpWrk directamente, sin el túnel SSH. Requiere contraseña de la interfaz.",
  "settings.remoteInstances.page.field.remoteLanAccessWarning": "Cualquiera en esa red puede llegar al OpWrk remoto. Solo lo protege la contraseña de la interfaz de abajo.",
  "settings.remoteInstances.page.validation.remoteLanNeedsPassword": "Define primero una contraseña de la interfaz. Sin ella, el OpWrk remoto quedaría abierto a todos los dispositivos de esa red.",
  ...
  "settings.remoteInstances.page.field.uiPasswordHintManaged": "Contraseña con la que se protegerá la interfaz remota de OpWrk. OpWrk la aplica al servidor que inicia por ti.",
  "settings.remoteInstances.page.field.uiPasswordHintExternal": "Contraseña del servidor OpWrk que ya se ejecuta en la máquina remota, usada para iniciar sesión.",
  ...
  "settings.remoteInstances.page.phase.installingOpenChamber": "Instalando OpWrk",
  "settings.remoteInstances.page.phase.updatingOpenChamber": "Actualizando OpWrk",
  ...
  "settings.providers.page.custom.field.apiKey.info": "Se guarda en la autenticación de OpenCode, no en OpWrk. Usa {env:VAR_NAME} para leer una clave del entorno.",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Las claves se envían directamente a OpenCode y nunca se almacenan en OpWrk.",
  ...
  "settings.github.page.flow.title": "Autorizar OpWrk",
  ...
  "settings.github.page.ghCli.fallbackDescription": "Disponible como respaldo si se elimina la autenticación de OpWrk",
  ...
  "settings.notifications.page.testNotification.body": "Esta es una notificación de prueba de OpWrk.",
  ...
  "settings.voice.page.tooltip.sttLocal": "Transcripción local en el servidor de OpWrk. Los modelos se descargan automáticamente; no se necesita clave de API.",
  "settings.voice.page.tooltip.localTts": "Síntesis local en el servidor de OpWrk (Kokoro para inglés; los modelos de otros idiomas se descargan en el primer uso). No requiere clave de API.",
  ...
  'settings.page.integrations.description': 'Conecta GitHub y Linear para que OpWrk pueda trabajar con tus issues y pull requests.',
} as const;
