...
export const dict: Record<I18nKey, string> = {
  ...
  "mobile.connect.welcome.title": "Conéctate a OpWrk",
  ...
  "mobile.connect.password.placeholder": "Contraseña de OpWrk",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de OpWrk.",
  ...
  "mobile.connect.relay.badge": "a través de OpWrk Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de OpWrk.",
  ...
  "sessions.sidebar.header.actions.addProject": "Añadir espacio de trabajo",
  ...
  "sessions.sidebar.footer.actions.aboutOpenChamber": "Acerca de OpWrk",
  ...
  "chat.chatInput.chooseProject": "Elegir espacio de trabajo",
  ...
  "sessions.sidebar.project.actions.projectMenu": "Menú del espacio de trabajo",
  "sessions.sidebar.project.actions.newSession": "Nueva sesión",
  "sessions.sidebar.project.actions.closeProject": "Cerrar espacio de trabajo",
  ...
  "contextRail.surface.editor.description": "Explorar y editar archivos del espacio de trabajo",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de OpWrk al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextRail.surface.notes.description": "Notas, tareas, planes y memoria del agente del espacio de trabajo",
  "contextRail.surface.notes": "Conocimiento del espacio de trabajo",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está OpWrk y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja OpWrk. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a OpWrk: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en OpWrk. Descárgalo para abrirlo con otra aplicación.",
  "filesView.artifact.document": "Documento",
  "filesView.artifact.spreadsheet": "Hoja de cálculo",
  "filesView.artifact.presentation": "Presentación",
  "filesView.artifact.readyTitle": "Listo para abrir: {type}",
  "filesView.csv.empty": "No hay filas para previsualizar.",
  "filesView.csv.previewLimited": "La vista previa es limitada. Cambia al modo de edición para ver el CSV completo.",
  "filesView.artifact.readyDescription": "OpWrk guardó este entregable en tu espacio de trabajo. Ábrelo en una aplicación compatible para revisarlo o editarlo.",
  "filesView.artifact.openDefaultApp": "Abrir en la aplicación predeterminada",
  "filesView.artifact.openFailed": "OpWrk no pudo abrir este archivo en la aplicación predeterminada.",
  ...
  "directoryExplorerDialog.title": "Añadir carpeta de espacio de trabajo",
  "directoryExplorerDialog.description": "Elige una carpeta para usarla como espacio de trabajo.",
  ...
  "directoryExplorerDialog.actions.addProject": "Añadir espacio de trabajo",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "OpWrk necesita acceso a esta carpeta.",
  ...
  "aboutDialog.openChamberVersionLabel": "Versión de OpWrk {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OpWrk, el estado de OpenCode, directorios y proyectos.",
  "aboutDialog.footerNote": "Hecho con amor para quienes aman su trabajo.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por OpWrk de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de OpWrk",
  "header.actions.openAppMenuAria": "Abrir menú de OpWrk",
  ...
  "chat.draftPresets.research.label": "Investigar un tema",
  "chat.draftPresets.analyzeFiles.label": "Analizar archivos",
  "chat.draftPresets.createDocument.label": "Crear un documento",
  "chat.draftPresets.createSpreadsheet.label": "Crear una hoja de cálculo",
  "chat.draftPresets.createPresentation.label": "Crear una presentación",
  "chat.draftPresets.createImage.label": "Crear una imagen",
  ...
  "chat.modelControls.agent.work": "Trabajar",
  "chat.modelControls.agent.plan": "Planificar",
  ...
  "projects.sharedTrust.description": "{path} en este repositorio define comandos que se ejecutan en esta máquina. Confía una vez y OpWrk solo volverá a preguntar cuando cambien.",
  ...
  "projectActions.actions.chooseActionAria": "Elegir acción del espacio de trabajo",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres OpWrk desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear OpWrk",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de OpWrk",
  ...
  "multiRun.window.description": "Ventana de OpWrk Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a OpWrk",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OpWrk no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de OpWrk. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OpWrk y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de OpWrk para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor OpWrk o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de OpWrk. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta OpWrk pero no es compatible con esta versión de la app. Actualiza OpWrk en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando OpWrk. Verifica que la dirección apunte a un servidor OpWrk.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando OpWrk. Verifica que la dirección apunte a un servidor OpWrk.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor OpWrk en \"{host}\" no es compatible con esta versión de la app. Actualiza OpWrk en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "OpWrk no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando OpWrk...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un momento y vuelve a cargar la página.",
  "updateDialog.error.signatureRejected": "La actualización descargada fue rechazada: su firma de código no coincide con esta instalación. Normalmente significa que la copia en ejecución no se instaló desde una versión oficial firmada. Instala OpWrk desde una versión oficial y vuelve a actualizar.",
  "updateDialog.error.updaterDisabled": "El actualizador se detuvo tras una instalación fallida. Cierra OpWrk, ábrelo de nuevo y reintenta la actualización.",
  "updateDialog.error.restartFailed": "No se pudo reiniciar para instalar la actualización.",
  "updateDialog.error.restartUnavailable": "Instalar la actualización requiere la aplicación de escritorio de OpWrk.",
  "mobileUpdate.toast.available.title": "Actualización de OpWrk disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén OpWrk abierto.",
  ...
  "openChamberLogo.aria.logo": "Logo de OpWrk",
