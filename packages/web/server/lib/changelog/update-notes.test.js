...
import { CHANGELOG_INDEX_URL, fetchUpdateNotes, renderUpdateNotes } from './update-notes.js';
...
describe('fetchUpdateNotes', () => {
  it('reads OpWrk release notes, not the inherited upstream index', () => {
    expect(CHANGELOG_INDEX_URL).toBe('https://raw.githubusercontent.com/temidayoxyz/opwrk/main/changelog/index.json');
  });
