...
- `bridge-system-runtime.ts`
  ...
  - The VS Code update check returns unavailable locally until OpWrk ships its own VSIX update channel; it makes no request to the inherited update service and creates no installation ID.
